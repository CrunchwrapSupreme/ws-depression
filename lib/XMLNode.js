import MoxyLikeJsonEncoder from './MoxyLikeJsonEncoder.js';
import NamespacesMap from './NamespacesMap.js';
import AttributesMap from './AttributesMap.js';
...
const m2o =
  Object.fromEntries
    ...
    : m => { const o = {}; for (const [k, v] of m.entries()) o[k] = v; return o; };

class XMLNode extends SAXEvent {
  ...
  cloneStart () {
    const e = new XMLNode(this.src, this[ENTITY_RESOLVER], SAXEvent.TYPES.START_ELEMENT);
  ...
  detach_children (list, o = {}) {
    ...
    let last = null; const a = []; for (const i of list) {
  ...
  trim () {
    const { src, type } = this; const ket = SAXEvent.KET.get(type);
